...
# pattern as a security measure. To unlock the device, you need to connect a sequence
# of dots/points in a grid by swiping your finger without lifting it as you trace the
# pattern through the screen.
